...
#   - false
#   - ask
config.set('content.geolocation', False, 'https://owl.purdue.edu')
...
#   - false
#   - ask
config.set('content.media.audio_capture', True, 'https://tamu.zoom.us')
...
#   - false
#   - ask
config.set('content.media.video_capture', True, 'https://tamu.zoom.us')
...
#   - false
#   - ask
config.set('content.media.video_capture', True, 'https://us06web.zoom.us')
...
#   - false
#   - ask
config.set('content.notifications.enabled', True, 'https://fosstodon.org')
...
c.content.proxy = 'http://192.168.1.201:8080/'
...
# for a blank page.
# Type: FuzzyUrl
#c.url.default_page = 'https://lx.vern.cc/'
...
config.bind('top.login', 'was not provided')
